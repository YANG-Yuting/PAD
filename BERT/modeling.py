...
class BertEncoder(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, model_ids=None, output_all_encoded_layers=True, head_mask=None):
        all_encoder_layers = []
        all_attentions = []
        for i, layer_module in enumerate(self.layer):
            ...
            if self.output_attentions:
                ...
                if i < 3:
                    ...
                    hidden_states += args.aux_weight * params_aux
                # if i==0:
                #     print(model_ids, x[:, :, -1])
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, model_ids=None, speaker_ids=None,
...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, model_ids=None, labels=None, head_mask=None):
        outputs = self.bert(input_ids, token_type_ids, attention_mask, model_ids=model_ids, output_all_encoded_layers=False, head_mask=head_mask)
